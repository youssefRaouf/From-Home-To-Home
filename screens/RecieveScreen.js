          ...
          <SafeAreaView>
            ...
            <View style={{ alignItems: 'center', marginTop: 20, }}>
              ...
              <LinearGradient colors={['#4c669f', '#335389', '#192f6a']}  style={{ flexDirection: 'row', height:200, justifyContent: 'space-between', alignItems: 'center', width: Dimensions.get('screen').width - 50, borderRadius: 15 }}>
                <Image style={{ width: 80, height: 100,marginLeft:15 }} resizeMode='contain' source={require("../assets/icons-04.png")}></Image>
                <View style={{
                  width: 0,
                  flexGrow: 1,
                  flex: 1
            ...
            <View style={{ alignItems: 'center', marginTop: 20 }}>
              ...
              <LinearGradient colors={['#4c669f', '#335389', '#192f6a']}  style={{  flexDirection: 'row', height:200, justifyContent: 'space-between', alignItems: 'center', width: Dimensions.get('screen').width - 50, borderRadius: 15 }}>
                <View >
                  <Image style={{ width: 100, height: 100,marginLeft:0 }} resizeMode='contain' source={require("../assets/cropped.png")}></Image>
                </View>
                <View style={{
                  width: 0,
                  flexGrow: 1,
            ...
            <View style={{ alignItems: 'center', marginTop: 20 }}>
              ...
              <LinearGradient colors={['#4c669f', '#335389', '#192f6a']}  style={{  flexDirection: 'row', height:200, justifyContent: 'space-between', alignItems: 'center', width: Dimensions.get('screen').width - 50, borderRadius: 15 }}>
                <Image style={{ width: 100, height: 100,marginLeft:0}} resizeMode='contain' source={require("../assets/icons-06.png")}></Image>
                <View style={{
                  width: 0,
                  flexGrow: 1,
                  flex: 1
